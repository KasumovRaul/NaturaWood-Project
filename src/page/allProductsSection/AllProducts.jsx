  ...
  return (
    ...
    <div className="category__page">
      ...
      <div className="category__container">
        ...
        >
          <p>All Products {filters.category.length > 0 && (
            <span style={{fontSize: "1.8rem", marginLeft:"10px"}}>
            - {filters.category.map(cat=> cat.charAt(0).toUpperCase() + cat.slice(1)).join(', ')}
            </span>
          )}</p>
        </div>
        ...
        <div className={`category__left__content ${OpenColumn ? "active" : ""}`}>
          <div className="cat__left__info">
            {OpenColumn && (
              <button onClick={handleColumnOpen} className="close__filter"><HiOutlineXMark /></button>
            )}
