...
const Login = () => {
   ...
   const handleSubmit = async (e) => {
       ...
       setTimeout(() => {
           setIsLoading(false);
           alert(isLogin ? "Entrance success" : "Account created")
       }, 2000);
   };
       ...
       <div className="login-header">
              <div className="login-icon">👤</div>
               ...
               <p className="login-subtitle">
                 {isLogin ? 'Log in to your account' : 'Create your new account'}
               </p>
              </div>
              ...
              <div className="login-form">
                ...
                <div className="form-group">
                  <span className="form-icon">✉️</span>
                      <input type="text" name='email' className='form-input' placeholder='Your E-mail'
                ...
                <button className={`submit-btn ${isLoading ? 'loading' : ''}`}
